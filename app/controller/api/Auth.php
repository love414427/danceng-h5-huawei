...
//        }
    ...
    {
        $user = $this->request->userInfo()->hidden(['label_id', 'group_id', 'pwd', 'address', 'card_id', 'last_time', 'last_ip', 'create_time', 'mark', 'status', 'spread_uid', 'spread_time', 'real_name', 'birthday', 'brokerage_price']);
